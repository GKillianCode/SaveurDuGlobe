...
class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public void successfulAuthentication(
        ...
        logger.info("successfulAuthentication -> Login of USER " + principal.getUsername());
        // Récupération de l'utilisateur en base
        User byEmail = userRepository.findByUsername(principal.getUsername());
        // Création du JWT
        String token = Jwts.builder()
                // SET du subject (identification de l'utilisateur (UNICITE))
                .setSubject(byEmail.getUsername())
