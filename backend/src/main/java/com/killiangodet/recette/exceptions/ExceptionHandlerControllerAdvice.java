package com.killiangodet.recette.exceptions;
...
public class ExceptionHandlerControllerAdvice {
    ...
    public ResponseEntity<ExceptionMessage> EntityExistsException(HttpServletRequest request, ConstraintViolationException exception) {
        ExceptionMessage exceptionMessage = new ExceptionMessage(request.getRequestURI(), exception.getMessage(), exception.getClass().getName());
        return new ResponseEntity<>(exceptionMessage, HttpStatus.INTERNAL_SERVER_ERROR);
    }
}